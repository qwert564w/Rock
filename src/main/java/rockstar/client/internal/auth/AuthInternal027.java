...
public class AuthInternal027
extends HttpPostRequest
implements ScriptInternal015<OAuthToken> {
    public AuthInternal027(OAuthClientConfig typedValue071, OAuthToken typedValue074) throws MalformedURLException {
        this(typedValue071, typedValue074.internalMethod06617());
    }

    public AuthInternal027(OAuthClientConfig typedValue071, String string) throws MalformedURLException {
