...
public class GameInternal021
extends InventoryInternal007 {
    public GameInternal021() {
        super("modules.settings.assist.stan", Items.NETHER_STAR.getDefaultStack(), CoreInternal039.internalField0460);
    }
