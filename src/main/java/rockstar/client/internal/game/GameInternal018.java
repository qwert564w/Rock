...
public class GameInternal018
extends InventoryInternal007 {
    public GameInternal018() {
        super("modules.settings.assist.plast", Items.DRIED_KELP.getDefaultStack(), CoreInternal039.internalField0460);
    }
