...
public class GameInternal013
extends InventoryInternal007 {
    public GameInternal013() {
        super("modules.settings.assist.aura", Items.PHANTOM_MEMBRANE.getDefaultStack(), CoreInternal039.internalField0460);
    }
