...
public class InventoryInternal019
extends InventoryInternal007 {
    public InventoryInternal019() {
        super("modules.settings.assist.wrath_potion", Items.SPLASH_POTION.getDefaultStack(), CoreInternal039.internalField1162);
    }
