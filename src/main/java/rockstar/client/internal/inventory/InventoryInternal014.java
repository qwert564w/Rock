...
public class InventoryInternal014
extends InventoryInternal007 {
    public InventoryInternal014() {
        super("modules.settings.assist.paladin_potion", Items.SPLASH_POTION.getDefaultStack(), CoreInternal039.internalField1162);
    }
