...
import rockstar.client.internal.render.RenderInternal013;

public class RenderInternal005
...
WindowAccess {
    ...
    public void internalMethod04833() {
        ...
        this.internalField0339 = new RenderInternal013(RockstarClient.id("blast_shockwave/data"));
    }

    public void internalMethod03482(Matrix4f matrix4f, List<RenderInternal012.InternalType0218> list) {
